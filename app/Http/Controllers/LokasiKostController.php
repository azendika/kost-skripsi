...
class LokasiKostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($katakunci)) {
            $data = LokasiKos::where('nama_kos', 'like', "%$katakunci%")
                ->orderBy('nama_kos', 'desc')
                ->paginate(5); 
        } else {
            $data = LokasiKos::orderBy('nama_kos', 'desc')
                ->paginate(5); 
        }
        return view('lokasi_kos.index')->with('data', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('lokasi_kos')->with('success', 'berhasil menambahkan data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->to('lokasi_kos')->with('success','berhasil melakukan delete');
    }
}
